	...
	*/
	...
	function ewf_load_customizer_css(){
		...
		<style id="ewf-customizer" >
			...
			#header { background-color: rgba( <?php  echo intval($ewf_color_header[0]).','.intval($ewf_color_header[1]).','.intval($ewf_color_header[2]); ?> , 0.5); } 
			#footer { background-color: <?php echo sanitize_text_field($ewf_color_footer); ?>; }
