<?php
	...
	#
	add_image_size( 'ewf-portfolio-list', 1170, 480, true);
			...
			'<div class="portfolio-item-2">
				...
				echo '
				   ...
				   <p>'.get_the_excerpt().'</p>
					...
					<a class="btn btn-white magnificPopup-gallery" href="'.$image_preview_large[0].'">'.__('zoom', EWF_SETUP_THEME_DOMAIN).'</a>
