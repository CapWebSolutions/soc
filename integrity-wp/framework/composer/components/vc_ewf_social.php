<?php
	...
	$class_extra = ' '.$css;
		...
		echo '<div class="fixed'.$class_extra.'">';
					...
					if ($url_flickr){
						echo '<a class="flickr-icon social-icon" href="'.$url_flickr.'">';
					...
					if ($url_rss){
						echo '<a class="rss-icon social-icon" href="'.$url_rss.'">';
							echo '<i class="fa fa-rss"></i>';
						echo '</a>';
					}
										
					if ($url_skype){
						echo '<a class="skype-icon social-icon" href="'.$url_skype.'">';
							echo '<i class="fa fa-skype"></i>';
						echo '</a>';
					}
					
					if ($url_xing){
						echo '<a class="xing-icon social-icon" href="'.$url_xing.'">';
							echo '<i class="fa fa-xing"></i>';
						echo '</a>';
					}
					
					if ($url_dropbox){
						echo '<a class="dropbox-icon social-icon" href="'.$url_dropbox.'">';
							echo '<i class="fa fa-dropbox"></i>';
						echo '</a>';
					}
					
					if ($url_windows){
						echo '<a class="windows-icon social-icon" href="'.$url_windows.'">';
							echo '<i class="fa fa-windows"></i>';
						echo '</a>';
					}
															
					if ($url_vimeo){
						echo '<a class="vimeo-icon social-icon" href="'.$url_vimeo.'">';
							echo '<i class="fa fa-vimeo-square"></i>';
						echo '</a>';
					}
					
					if ($url_github){
						echo '<a class="github-icon social-icon" href="'.$url_github.'">';
