...
#
	...
	// include_once ('modules/ewf-parallax/ewf-parallax.php'); 
...
#
	...
	include_once ('components/vc_ewf_timeline.php');	
	include_once ('components/vc_ewf_animation.php');	
	include_once ('components/vc_ewf_countdown.php');	
	...
	// include_once ('components/vc_ewf_portfolio_parallax.php'); 
	// include_once ('components/vc_ewf_portfolio_slider.php');
