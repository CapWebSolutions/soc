	...
	jQuery(document).ready(function($) {
		...
		$( "#_ewf_modHeader_master_id" ).change(function(){
			...
			var master_border_color 	= $(master_page).attr('data-border-color');
			...
			*/
			...
			var background_color_field = $('#_ewf_modHeader_background_color').closest('.mh-field-color');
			if (master_background_color){
				$('.wp-color-result', background_color_field).css('background-color', master_background_color);
				// $('input', background_color_field).val(master_background_color);
			}else{
				var background_color = $(background_color_field).attr('data-color');
				$('.wp-color-result', background_color_field).css('background-color', master_background_color);
				// $('input', background_color_field).val(background_color);
			}
			
			
			var border_color_field = $('#_ewf_modHeader_border_color').closest('.mh-field-color');
			if (master_border_color){
				$('.wp-color-result', border_color_field).css('background-color', master_border_color);
				// $('input', border_color_field).val(master_border_color);
			}else{
				var border_color = $(border_color_field).attr('data-color');
				$('.wp-color-result', border_color_field).css('background-color', border_color);
				// $('input', border_color_field).val(border_color);
				
				console.log('default: '+border_color);
			}
			...
			$('.ewf-mh-useMaster .toggle').on('toggle', function (e, active) {
				...
				$.post( ajaxPath, { "action":'ewf_modHeader_master_use', 'master_use':active, 'post':postID  }, function(data){
					...
					if (active){
						...
						var master_border_color = $('.ewf-mh-pages-data-cache a[data-id="'+master_id+'"]').attr('data-border-color');
						...
						var background_color_field = $('#_ewf_modHeader_background_color').closest('.mh-field-color');
						if (master_background_color){
							var background_color_style = $('.wp-color-result', background_color_field).attr('style');
							$('.wp-color-result', background_color_field).attr('style-original', background_color_style);
							$('.wp-color-result', background_color_field).css('background-color', master_background_color);
						}
						...
						var border_color_field = $('#_ewf_modHeader_border_color').closest('.mh-field-color');
						if (master_border_color){
							var border_color_style = $('.wp-color-result', border_color_field).attr('style');
							$('.wp-color-result', border_color_field).attr('style-original', border_color_style);
							$('.wp-color-result', border_color_field).css('background-color', master_border_color);
						}
						...
						*/
						...
						var background_color_field = $('#_ewf_modHeader_background_color').closest('.mh-field-color');
						var background_color = $(background_color_field).attr('data-color');
						$('.wp-color-result', background_color_field).css('background-color', background_color);
						...
						// var border_color_field = $('#_ewf_modHeader_background_color').closest('.mh-field-color');
						// if (master_border_color){
							// var border_color_style = $('.wp-color-result', border_color_field).attr('style');
							// $('.wp-color-result', border_color_field).attr('style-original', border_color_style);
							// $('.wp-color-result', border_color_field).css('background-color', master_border_color);
